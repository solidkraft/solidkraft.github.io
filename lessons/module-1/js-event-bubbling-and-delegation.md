...
For a review of how to set event handlers, please refer to the [DOM Manipulation with JavaScript Lesson](http://academy.solidkraft.com/lessons/module-1/js-3-dom-manipulation.html)
...
Clone [this](https://github.com/solidkraft/eventPractice) repository to your
...
Using [this repo](https://github.com/solidkraft/eventPractice) `open example2/index.html` for this pair practice, and modify `script.js`
